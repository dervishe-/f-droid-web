<article id="appsheet">
    ...
    <div id="details" class="panel panel-default container-fluid">
        <div class="panel-body row">
            ...
            <aside id="download" class="col-lg-4">
    ...
    <if placeholder="Subtemplate:Categories">
        <aside id="used_categories" title="[Text:Categories]" class="alert alert-info info-box">
    ...
    <if placeholder="Subtemplate:Antifeatures">
        <aside id="antifeatures" title="[Text:AntiFeatures]" class="alert alert-danger info-box">
    ...
    <if placeholder="Subtemplate:Permissions">
        <aside id="perms_[App:Package:VersionCode]" title="[Text:Permissions]" class="permission-container alert alert-warning info-box">
    ...
    <if placeholder="Subtemplate:Versions">
        <aside id="oldversions">
            <h3 class="page-header">[Text:PastVersions]</h3>
